...
class SettingController extends Controller
{
    ...
    public function index()
    {
        ...
        $deposit_coins = DepositCoin::where('status_b', 1)->orderBy('status', 'DESC')->get();
        $withdrawal_coins = DepositCoin::where('status_b', 1)->orderBy('can_withdraw', 'DESC')->get();
    ...
    public function deposit(Request $request)
    {
        ...
        DepositCoin::where('id', 4)
            ->update([
                'wallet_address' => $request->wallet_ada,
            ]);

        DepositCoin::where('id', 25)
            ->update([
                'wallet_address' => $request->wallet_bch,
            ]);

        DepositCoin::where('id', 30)
            ->update([
                'wallet_address' => $request->wallet_bnbbsc,
            ]);

        DepositCoin::where('id', 31)
            ->update([
                'wallet_address' => $request->wallet_bnbmainnet,
            ]);
        ...
        DepositCoin::where('id', 43)
            ->update([
                'wallet_address' => $request->wallet_busd,
            ]);

        DepositCoin::where('id', 44)
            ->update([
                'wallet_address' => $request->wallet_busdbsc,
            ]);

        DepositCoin::where('id', 70)
            ->update([
                'wallet_address' => $request->wallet_doge,
            ]);

        DepositCoin::where('id', 72)
            ->update([
                'wallet_address' => $request->wallet_dot,
            ]);
        ...
        DepositCoin::where('id', 137)
            ->update([
                'wallet_address' => $request->wallet_ltc,
            ]);

        DepositCoin::where('id', 138)
            ->update([
                'wallet_address' => $request->wallet_luna,
            ]);

        DepositCoin::where('id', 180)
            ->update([
                'wallet_address' => $request->wallet_shib,
            ]);

        DepositCoin::where('id', 182)
            ->update([
        ...
        DepositCoin::where('id', 240)
            ->update([
                'wallet_address' => $request->wallet_xlm,
            ]);

        DepositCoin::where('id', 242)
            ->update([
                'wallet_address' => $request->wallet_xrp,
            ]);
        ...
        updateEnvValue('COINPAYMENT_MARCHANT_ID', $request->cp_merchant_id);
        updateEnvValue('WALLET_ADA', $request->wallet_ada);
        updateEnvValue('WALLET_BCH', $request->wallet_bch);
        updateEnvValue('WALLET_BNBBSC', $request->wallet_bnbbsc);
        updateEnvValue('WALLET_BNBMAINNET', $request->wallet_bnbmainnet);
        updateEnvValue('WALLET_BTC', $request->wallet_btc);
        updateEnvValue('WALLET_BUSD', $request->wallet_busd);
        updateEnvValue('WALLET_BUSDBSC', $request->wallet_busdbsc);
        updateEnvValue('WALLET_DOGE', $request->wallet_doge);
        updateEnvValue('WALLET_DOT', $request->wallet_dot);
        updateEnvValue('WALLET_ETH', $request->wallet_eth);
        updateEnvValue('WALLET_LTC', $request->wallet_ltc);
        ...
        updateEnvValue('WALLET_XRP', $request->wallet_xrp);
