...
style="background-image: url(&quot;/prime/images/forbanner.jpg&quot;); position: relative; min-height: 100%; top: 0px;">
    ...
    <div id="layout-wrapper">
       ...
       <!-- <div class="vertical-menu">
        ...
        <!-- JAVASCRIPT -->
        <script src="/prime/1/assets/libs/jquery/jquery.min.js"></script>
        <script src="/prime/1/assets/libs/bootstrap/js/bootstrap.bundle.min.js"></script>
        <script src="/prime/1/assets/libs/metismenu/metisMenu.min.js"></script>
        <script src="/prime/1/assets/libs/simplebar/simplebar.min.js"></script>
        <script src="/prime/1/assets/libs/node-waves/waves.min.js"></script>
        <script src="/prime/1/assets/libs/waypoints/lib/jquery.waypoints.min.js"></script>
        <script src="/prime/1/assets/libs/jquery.counterup/jquery.counterup.min.js"></script>
...
*/
        ...
        <!-- apexcharts -->
        <script src="/prime/1/assets/libs/apexcharts/apexcharts.min.js"></script>

        <script src="/prime/1/assets/js/pages/dashboard.init.js"></script>

        <script src="/prime/1/assets/js/app.js"></script>
