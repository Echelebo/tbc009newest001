...
<head>
    ...
    <!-- Animate CSS -->
    <link rel="stylesheet" href="/prime/node_modules/animate.css/animate.min.css">
...
<body class="bg-image bg-fixed" data-img-src="/prime/images/forbanner.jpg" data-new-gr-c-s-check-loaded="14.1159.0"
        ...
        <div class="row min-vh-100 align-content-between">
                ...
                <div class="row align-items-center py-4">
                    ...
                    <div class="col-md-6">
                        <div class="text-center text-md-left px-4 mb-4 mb-md-0">
                            <a href="{{ route('user.login') }}"><img src="/prime/images/logo.png" alt="logo" data-width="100px"
                                    data-height="100px" style="width: 100px; height: 100px;"></a>
                        </div>
                    </div>

                    <div class="col-md-6">
                        <div class="text-center text-md-right px-4">
                            <a href="{{ route('user.login') }}" class="text-light font-weight-600 text-uppercase"><i
                                    class="fas fa-angle-left mr-2" aria-hidden="true"></i>Go to main</a>
                        </div>
                    </div>
            ...
            <div class="col-12 pt-md-3">
                <div class="text-center text-white-75 p-4 mt-md-1">
                    <small>Copyright @ <a href="{{ route('home') }}"
                            class="text-light font-weight-600">{{ site('name') }}</a>. All Rights Reserved.</small>
                </div>
            </div>
    ...
    <!-- Bootstrap js -->
    <script src="/prime/node_modules/bootstrap/dist/js/bootstrap.bundle.min.js"></script>

    <!-- Navik Menu js -->
    <script src=/prime/"components/navik-navigation-menu/dist/js/navik.menu.js"></script>

    <!-- Isotope and imagesloaded js -->
    <script src="/prime/node_modules/isotope-layout/dist/isotope.pkgd.min.js"></script>
    <script src="/prime/node_modules/imagesloaded/imagesloaded.pkgd.min.js"></script>
 ...
 */
    ...
    <script type="text/javascript"
        src="/prime/translate.google.com/translate_a/elementa0d8.js?cb=googleTranslateElementInit"></script>
