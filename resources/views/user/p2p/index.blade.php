                        ...
                        <div class="mt-5 hidden" id="display-new-transfer-information">
                            <div class=" p-2 rounded w-full">
                                ...
                                <div class="grid grid-cols-2 gap-2 text-mono text-sm break-all">
                                    ...
                                    <h2 class="font-bold" style="font-size: 14px;"><span id="display_transfer_network"
                            ...
                            <div class="flex  space-x-2">
                                ...
                                <div class=" p-2 rounded w-full">
                                    <div class="grid grid-cols-2 gap-2 text-mono text-sm">
                                        ...
                                        <h2 class="font-bold text-16">:{{ formatAmount(site('min_transfer')) }}</h2>
                                        <h2 class="text-16">Maximum transfer </h2>
                                        <h2 class="font-bold text-16">:{{ formatAmount(site('max_transfer')) }}</h2>
                                        <h2 class="text-16">Fee </h2>
                                        <h2 class="font-bold text-16">:{{ site('transfer_fee') }}%</h2>
