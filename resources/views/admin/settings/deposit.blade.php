            ...
            <form action="{{ route('admin.settings.deposit') }}" method="POST" class="mt-5 gen-form" data-action="none"
                ...
                <div class="grid grid-cols-1 gap-5">
                   ...
                   <div class="mt-5">
                    ...
                    <div class="relative mt-5">
                        <input type="text" name="wallet_usdtbsc" placeholder="USDTBSC Wallet" id="wallet_usdtbsc"
                            class="theme1-text-input pl-3" required value="{{ demoMask(env('WALLET_USDTBSC')) }}">
                        <label for="wallet_usdtbsc" class="placeholder-label text-gray-300 ts-gray-2 px-2">USDTBSC Wallet</label>
