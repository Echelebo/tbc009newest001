        ...
        <div class="w-full lg:flex lg:gap-3">
            ...
            <div class="w-full lg:w-2/3">
                <div class="w-full p-5 mb-5 ts-gray-2 rounded-lg transition-all rescron-card hidden" id="activations">
                    <h3 class="capitalize  font-extrabold "><span class="border-b-2">Plan Activations</span>
                    </h3>
                        ...
                        <div class="grid grid-cols-1 gap-3 mt-5">
                                            ...
                                            <div class="w-full">
                                                <div class="grid grid-cols-2 lg:grid-cols-3 gap-2">
                                                    ...
                                                    <p class="text-xs text-mono grid grid-cols-1"><span
                                                        ...
                                                        <span><a href="{{ route('admin.users.view', ['id' => $bot->user->id ]) }}">{{ $bot->user->name }}</a></span>
                                                    </p>
                            ...
                            @empty
                                <div
                                    ...
                                    <span>You have not activated any plan</span>
                                </div>
                            @endforelse
                    ...
                    <div class="w-full mt-5 grid grid-cols-2 lg:grid-cols-3 gap-2">
                        <div
                            ...
                            <div class="w-full flex items-center justify-between">
                                <div>
                                    <div class="mb-1">
                                        <p class=" font-bold text-gray-500">Total Plans</p>
                                    </div>
                ...
                <div class="w-full p-5 mb-5 ts-gray-2 rounded-lg transition-all rescron-card hidden" id="add-new-bot">
                    <h3 class="capitalize  font-extrabold "><span class="border-b-2">Add New Plan</span>
                    </h3>
